...
def predict():
	...
	img_path = '/home/liquan/PycharmProjects/python_c_tensorflow-master/test_pic/cat.jpeg'
	...
	try:
		...
		print(' Predicted: ', keras.applications.vgg19.decode_predictions(results, top=1)[0])
