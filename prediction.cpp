...
int main(int argc, char *argv[]){
	...
	PyRun_SimpleString("sys.path.append('/home/liquan/PycharmProjects/inception_dec_2015/')");

	PyObject *pName,*pModule,*pDict,*pFunc;
	
	// PyString_FromString for python2.x
	// PyUnicode_DecodeFSDefault for python3.x
	//pName = PyUnicode_DecodeFSDefault("/home/liquan/CProjects/python_c_tensorflow-master/vgg_model");
	pName = PyString_FromString("inception_2");
